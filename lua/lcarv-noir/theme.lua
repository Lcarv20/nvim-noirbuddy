...
function M.setup(opts)
  ...
  Group.new('Conceal', colors.comment)
  ...
  Group.new('VertSplit', colors.secondary, colors.noir_9)
  Group.new('WinSeparator', colors.secondary, colors.noir_9)

  Group.new('Folded', colors.noir_5, colors.noir_8)
  Group.new('FoldColumn', colors.comment)
  Group.new('MatchParen', nil, colors.comment)
